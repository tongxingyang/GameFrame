...
//    [InitializeOnLoad]
    public static  class LuaEditor
    {
        ...
        {
            string path = Application.dataPath +"/src";
...
//        public const string SrcLuaPath = "";
//        public const string DesLuaPath = "";
        public static string SrcLuaPath = Application.dataPath + "/src";
        public static  string DesLuaPath = Application.dataPath + "/des";
